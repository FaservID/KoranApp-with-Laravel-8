...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  ------------------------------------- */
            ...
            .header-background {
                background: repeat-x
                    url(https://www.filepicker.io/api/file/wUGKTIOZTDqV2oJx5NCh)
                    left bottom;
            }
  ...
  -------------------------------------------- */
    ...
    <body bgcolor="#ffffff">
        <div align="center">
            <table
                class="head-wrap w320 full-width-gmail-android"
                bgcolor="#f9f8f8"
                cellpadding="0"
                cellspacing="0"
                border="0"
            >
                <tr>
                    <td
                        background="https://www.filepicker.io/api/file/UOesoVZTFObSHCgUDygC"
                        bgcolor="#ffffff"
                        width="100%"
                        height="8"
                        valign="top"
          ...
          <![endif]-->
                                        ...
                                        <table class="soapbox">
                                            <tr>
                                                <td class="soapbox-title">
                                                    ...
                                                    Tagihan Koran Anda Bulan {{ $data['bulan'] }} adalah sejumlah
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="body">
                                            <tr>
                                                ...
                                                <td class="body-padded">
                                                    ...
                                                    <table class="body-text">
                                                        <tr>
                                                            <td class="body-text-cell">
                                                                Mohon Untuk Segera Lakukan Pembayaran Di Kurir / Transfer Ke Rekening Kantor. <br>
                                                                <tt>Abaikan Pesan ini apabila anda sudah melakukan pembayaran.</tt>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table
                                                        class="body-signature-block">
                                                        <tr>
                                                            <td
                                                                class="body-signature-cell">
                                                                <p>
                                                                    Regards,
                                                                </p>
            ...
            <table
                class="footer-wrap w320 full-width-gmail-android"
                bgcolor="#e5e5e5"
            >
                <tr>
                    <td>
                        <div class="content footer-lead">
                            <a href="#"><b>Get in touch</b></a> if you have any
